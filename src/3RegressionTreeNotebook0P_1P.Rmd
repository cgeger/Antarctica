...
###Regression trees for Zero-Pass 1-Pass average infiltration time difference (`X0P_1P_AV_TIME`)

###Regression trees for Zero-Pass average infiltration time (`X0P_1P_AV_TIME`)
>>>>>>> 387cff27930376e77231a1a005b73e1d447af752
...
```{r}
library(tree)
model2 <- tree(formula = i0P_1P_AV_TIME ~ ., 
          data = df)
model2
summary(model2)
plot(model2)
